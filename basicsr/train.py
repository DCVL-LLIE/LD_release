...
def parse_options(is_train=True):
    ...
    parser.add_argument('--info', type=str, default=None, help='Additional information for the experiment name.')
    parser.add_argument(
        '--launcher',
...
def main():
    ...
    if resume_state:  # resume training
        ...
        logger.info(f'best ssim: {best_ssim} from iteration {best_iter}')
    else:
        model = create_model(opt)
        start_epoch = 0
        current_iter = 0
